...
for armour in armours:
    ...
    two_normal_att = attack(10, armour)
    one_normal_att = attack(8, armour) + attack(6, armour)
    two_wreckless_att = attack(10, armour, advantage=True)
    one_wreckless_att = attack(8, armour, advantage=True) + attack(6, armour, advantage=True)
    #two_heavy_att = attack(10, armour, heavy=True)
    #two_heavy_wreckless_att =  attack(10, armour, heavy=True, advantage=True)
